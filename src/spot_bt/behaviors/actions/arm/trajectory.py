    ...
    def update(self) -> py_trees.common.Status:
        ...
        try:
            ...
            if self.feedback is None:
                ...
                robot_state = self.client.get_robot_state()
                ...
                # Send the request
                cmd_id = self.client.robot_command(command)

            # Wait until the arm arrives at the goal.
            self.feedback = self.client.robot_command_feedback(cmd_id)
        ...
        try:
            ...
            if (
                ...
                if self.count > len(self.possible_targets):
                    self.robot.logger.info("All moves complete!")
                    return py_trees.common.Status.SUCCESS
